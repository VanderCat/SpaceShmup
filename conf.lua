function love.conf(t)
    t.identity = "SpaceShmap"           -- Имя папки, в которую LÖVE будет сохранять файлы (строка)
    t.appendidentity = false            -- Искать файлы в корневой папке игры перед их поиском в папке сохранений (логическое)
    t.version = "11.3"                  -- Версия LÖVE для которой была сделана игра (строка)
    ...
    t.window.title = "SpaceShmap"       -- Заголовок окна (строка)
